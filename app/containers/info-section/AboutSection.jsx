...
const AboutSection = () => {
  return (
    <div className="flex flex-col items-center min-h-min  py-5 space-y-10 w-full">
      <div className="text-orange-400 font-bold text-7xl">ABOUT ME</div>
      ...
      <div className="flex flex-col space-y-5 md:space-y-0 lg:space-y-0 md:flex-row lg:flex-row md:justify-evenly lg:justify-evenly w-full  ">
        {/* ******************** Hobbies block ******************* */}
        <div className="flex flex-col items-center space-y-5">
          <h2 className="font-bold text-3xl ">HOBBIES</h2>
          <div className="grid grid-cols-2 gap-4">
            <div className="w-50 h-50 p-5 rounded-xl border-slate-400 border-2 border-opacity-10 hover:border-opacity-40 hover:shadow-md hover:shadow-white ">
              <Image

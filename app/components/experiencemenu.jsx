            ...
            <div className="flex flex-row justify-start space-x-5">
              ...
              <div className="flex flex-col w-96 ">
                <div className="flex flex-row text-wrap">
                  ...
                  <p className="text-orange-400">Myoo.io</p>
                </div>
        ...
        <div role="tabpanel" className="tab-content p-10">
          <div className="flex flex-col items-center space-y-5 w-full ">
            <div className="flex flex-row justify-start space-x-5">
              ...
              <div className="flex flex-col w-96 ">
                <div className="flex flex-row text-wrap">
                  <p>Developer @ </p> <p className="text-orange-400">MyHealp</p>
                </div>
          ...
          <div className="flex flex-col items-center space-y-5 w-full ">
            <div className="flex flex-row justify-start space-x-5">
              ...
              <div className="flex flex-col w-96 ">
                <div className="flex flex-row text-wrap">
                  <p>Web Developer @ </p>{" "}
                  <a className="text-orange-400" href="google.com">
                    GourmetFuel
                  </a>
                </div>
        ...
        <div role="tabpanel" className="tab-content p-10">
          <div className="flex flex-col items-center space-y-5 w-full ">
            <div className="flex flex-row justify-start space-x-5">
              ...
              <div className="flex flex-col w-96 ">
                <div className="flex flex-row text-wrap">
                  <p>SysAdmin @ </p> <p className="text-orange-400">SiOlot</p>
                </div>
